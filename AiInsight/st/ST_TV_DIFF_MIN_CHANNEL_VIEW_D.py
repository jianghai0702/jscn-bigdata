...
# -*-coding:utf-8 -*-
#-------------------------------------------------------------------------------
# Name:ST直播各分钟各频道收视情况(日)
# Pay:ST_TV_DIFF_MIN_CHANNEL_VIEW_D.py
# Purpose:
#
# Author:      chens
#
...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_tv_diff_min_channel_view_d    =    "st_tv_diff_min_channel_view_d"      
##===========================================================================       
##创建临时表                                                        
##===========================================================================
...
##===========================================================================
#生成    当天的记录；
    hsql='''insert overwrite table %(t_st_tv_diff_min_channel_view_d)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
            select
                t1.cycle_id,
                ...
                t1.std_minute_name,
                t1.tv_time,
                case when coalesce(t3.tv_user_count,0)=0 then 0 
                     else round(t1.tv_time/t3.tv_user_count*100,2) end tv_minute_trend,
                case when coalesce(t3.tv_user_count,0)=0 then 0 else round(t1.tv_time/t3.tv_user_count*100,2) end tv_rate,
             ...
             left join %(s_st_tv_diff_min_view_d)s t2 on t1.own_corp_std_org_code = t2.own_corp_std_org_code
             and t1.std_minute_code = t2.std_minute_code
