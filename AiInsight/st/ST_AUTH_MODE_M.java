// ORM class for table 'ST_AUTH_MODE_M'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Jul 05 12:33:08 CST 2019
...
public class ST_AUTH_MODE_M extends SqoopRecord  implements DBWritable, Writable {
  ...
  public ST_AUTH_MODE_M with_CYCLE_ID(String CYCLE_ID) {
    this.CYCLE_ID = CYCLE_ID;
    return this;
  }
  private String STD_AUTH_MODE_CODE;
  public String get_STD_AUTH_MODE_CODE() {
    return STD_AUTH_MODE_CODE;
  }
  public void set_STD_AUTH_MODE_CODE(String STD_AUTH_MODE_CODE) {
    this.STD_AUTH_MODE_CODE = STD_AUTH_MODE_CODE;
  }
  public ST_AUTH_MODE_M with_STD_AUTH_MODE_CODE(String STD_AUTH_MODE_CODE) {
    this.STD_AUTH_MODE_CODE = STD_AUTH_MODE_CODE;
    return this;
  }
  private String STD_AUTH_MODE_NAME;
  public String get_STD_AUTH_MODE_NAME() {
    return STD_AUTH_MODE_NAME;
  }
  public void set_STD_AUTH_MODE_NAME(String STD_AUTH_MODE_NAME) {
    this.STD_AUTH_MODE_NAME = STD_AUTH_MODE_NAME;
  }
  public ST_AUTH_MODE_M with_STD_AUTH_MODE_NAME(String STD_AUTH_MODE_NAME) {
    this.STD_AUTH_MODE_NAME = STD_AUTH_MODE_NAME;
    return this;
  }
  ...
  public ST_AUTH_MODE_M with_AUTH_COUNT(java.math.BigDecimal AUTH_COUNT) {
    this.AUTH_COUNT = AUTH_COUNT;
    return this;
  }
  ...
  public ST_AUTH_MODE_M with_AUTH_RATE(java.math.BigDecimal AUTH_RATE) {
    this.AUTH_RATE = AUTH_RATE;
    return this;
  }
  ...
  public ST_AUTH_MODE_M with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  ...
  public ST_AUTH_MODE_M with_OWN_CORP_STD_ORG_CODE(String OWN_CORP_STD_ORG_CODE) {
    this.OWN_CORP_STD_ORG_CODE = OWN_CORP_STD_ORG_CODE;
    return this;
  }
  ...
  public ST_AUTH_MODE_M with_OWN_CORP_STD_ORG_NAME(String OWN_CORP_STD_ORG_NAME) {
    this.OWN_CORP_STD_ORG_NAME = OWN_CORP_STD_ORG_NAME;
    return this;
  }
  ...
  public ST_AUTH_MODE_M with_PT_MON(String PT_MON) {
    this.PT_MON = PT_MON;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ST_AUTH_MODE_M)) {
      return false;
    }
    ST_AUTH_MODE_M that = (ST_AUTH_MODE_M) o;
    boolean equal = true;
    equal = equal && (this.CYCLE_ID == null ? that.CYCLE_ID == null : this.CYCLE_ID.equals(that.CYCLE_ID));
    equal = equal && (this.STD_AUTH_MODE_CODE == null ? that.STD_AUTH_MODE_CODE == null : this.STD_AUTH_MODE_CODE.equals(that.STD_AUTH_MODE_CODE));
    equal = equal && (this.STD_AUTH_MODE_NAME == null ? that.STD_AUTH_MODE_NAME == null : this.STD_AUTH_MODE_NAME.equals(that.STD_AUTH_MODE_NAME));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.STD_AUTH_MODE_CODE = JdbcWritableBridge.readString(2, __dbResults);
    this.STD_AUTH_MODE_NAME = JdbcWritableBridge.readString(3, __dbResults);
    this.AUTH_COUNT = JdbcWritableBridge.readBigDecimal(4, __dbResults);
    this.AUTH_RATE = JdbcWritableBridge.readBigDecimal(5, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(STD_AUTH_MODE_CODE, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(STD_AUTH_MODE_NAME, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(AUTH_COUNT, 4 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(AUTH_RATE, 5 + __off, 3, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.STD_AUTH_MODE_CODE = null;
    } else {
    this.STD_AUTH_MODE_CODE = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.STD_AUTH_MODE_NAME = null;
    } else {
    this.STD_AUTH_MODE_NAME = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.STD_AUTH_MODE_CODE) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, STD_AUTH_MODE_CODE);
    }
    if (null == this.STD_AUTH_MODE_NAME) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, STD_AUTH_MODE_NAME);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(STD_AUTH_MODE_CODE==null?"null":STD_AUTH_MODE_CODE, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(STD_AUTH_MODE_NAME==null?"null":STD_AUTH_MODE_NAME, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.STD_AUTH_MODE_CODE = null; } else {
      this.STD_AUTH_MODE_CODE = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.STD_AUTH_MODE_NAME = null; } else {
      this.STD_AUTH_MODE_NAME = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    ST_AUTH_MODE_M o = (ST_AUTH_MODE_M) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(ST_AUTH_MODE_M o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("STD_AUTH_MODE_CODE", this.STD_AUTH_MODE_CODE);
    __sqoop$field_map.put("STD_AUTH_MODE_NAME", this.STD_AUTH_MODE_NAME);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("STD_AUTH_MODE_CODE".equals(__fieldName)) {
      this.STD_AUTH_MODE_CODE = (String) __fieldVal;
    }
    else    if ("STD_AUTH_MODE_NAME".equals(__fieldName)) {
      this.STD_AUTH_MODE_NAME = (String) __fieldVal;
    }
