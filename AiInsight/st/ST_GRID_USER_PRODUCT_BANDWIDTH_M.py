...
#-------------------------------------------------------------------------------
# Name: ST网格用户发展带宽统计
# Pay: ST_GRID_USER_PRODUCT_BANDWIDTH_M.py
...
# 目标表声明
#-------------------------------------------------------------------------------
t_st_grid_user_product_bandwidth_m                    =    "st_grid_user_product_bandwidth_m"    
...
try:
    ...
    hsql='''
        insert overwrite table %(t_st_grid_user_product_bandwidth_m)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
        SELECT t.cycle_id,
