...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_web_browse_m       				          =    "st_web_browse_m"
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
...
##===========================================================================
#插入当前dwd全量数据
    hsql='''insert overwrite table %(t_st_web_browse_m)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
            select
              %(ARG_OPTIME_LAST1_M)s cycle_id,
              t1.monitor_city region_name,
              round(avg(t1.performance),2) performance,
              round(avg(t1.first_screen_time),2) first_screen_time,
              round(avg(t1.download_speed),2) download_speed,
              count(*) monitor_count,
              from_unixtime(unix_timestamp(),'yyyy-MM-dd HH:mm:ss') etl_date,
              round(avg(t1.basic_doc_download_bytes),2) basic_doc_download_bytes
