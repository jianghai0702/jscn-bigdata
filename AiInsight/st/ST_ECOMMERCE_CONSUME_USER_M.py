...
#-------------------------------------------------------------------------------
# Name: ST电商消费情况统计(月)
# Pay: ST_ECOMMERCE_CONSUME_USER_M.py
# Purpose:
#
# Author:      lvdp
#
...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_ecommerce_consume_user_m             =    "st_ecommerce_consume_user_m"
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
...
#插入当前dwd全量数据
#TODO
    hsql='''insert overwrite table %(t_st_ecommerce_consume_user_m)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
            select
