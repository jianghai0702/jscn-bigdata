...
#-------------------------------------------------------------------------------
# Name:ST不同网站类型访问用户
# Pay:ST_DIFF_URL_TYPE_USER_M.py
# Purpose: 
#
# Author:      zhangzc
#
...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_diff_url_type_user_m               =    "st_diff_url_type_user_m"    
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
#补上线时间在前三天的访问数据
    hsql='''insert overwrite table %(t_st_diff_url_type_user_m)s partition(pt_mon = %(ARG_OPTIME_LAST_M)s)
    select
     ...
     from %(s_dwa_diff_organize_user_m)s t1 
         ...
         group by own_corp_std_org_code,own_corp_std_org_name,url_type
     '''% vars()
