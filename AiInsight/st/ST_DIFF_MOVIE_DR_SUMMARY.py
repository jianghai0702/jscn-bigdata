...
#-------------------------------------------------------------------------------
# Name:ST不同节目点播统计
# Pay:ST_DIFF_MOVIE_DR_SUMMARY.py
# Purpose:
#
# Author:      zhangzc
#
...
#-------------------------------------------------------------------------------
# wangxx 2018-12-13
# 调整回看节目统计，节目名称不从dwd_vod_movie_master取，应为回看节目id在该表关联不上。
# dwd_vod_movie_master同一节目又多条记录，不宜关联统计。
#
...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_diff_movie_dr_summary              =    "st_diff_movie_dr_summary"
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
...
##===========================================================================
#生成 当天数据
    hsql='''insert overwrite table %(t_st_diff_movie_dr_summary)s PARTITION(pt_mon = %(ARG_OPTIME_LAST1_M)s)
...
#生成 当月数据  地区级
    hsql='''insert into table %(t_st_diff_movie_dr_summary)s PARTITION(pt_mon = %(ARG_OPTIME_LAST1_M)s)       
...
from %(t_st_diff_movie_dr_summary)s a
inner join %(s_dim_std_organize)s b
on a.OWN_CORP_STD_ORG_CODE = b.STD_ORG_CODE
