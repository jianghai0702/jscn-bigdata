...
#-------------------------------------------------------------------------------
# Name:ST不同网站不同设备访问用户
# Pay:ST_DIFF_URL_DIFF_DEVICE_USER_M.py
# Purpose: 
#
# Author:      zhangzc
#
...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_diff_url_diff_device_user_m                =    "st_diff_url_diff_device_user_m"    
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
#不同网站（URL）访问次数
    hsql='''insert overwrite table %(t_st_diff_url_diff_device_user_m)s partition(pt_mon = %(ARG_OPTIME_LAST_M)s)
    select
     ...
     from %(s_dwa_diff_organize_user_m)s t1 
         ...
         group by own_corp_std_org_code,OWN_CORP_STD_ORG_NAME,STD_DEVICE_CATE_CODE,STD_DEVICE_CATE_NAME,URL
     '''% vars()
