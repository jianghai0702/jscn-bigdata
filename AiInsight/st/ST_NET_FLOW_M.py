...
##自定义变量声明---源表声明                                                          
##===========================================================================     
    s_stg_net_flow_m                           =    "stg_net_flow_m"
##===========================================================================       
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_net_flow_m       				       =    "st_net_flow_m"
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
...
#插入当前dwd全量数据
#TODO
    hsql='''insert overwrite table %(t_st_net_flow_m)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
            select
              %(ARG_OPTIME_LAST1_M)s cycle_id,
              '' own_corp_std_org_code,
              t1.corp_code own_corp_std_org_name,
              t1.in_net_flow,
              t1.out_net_flow,
              from_unixtime(unix_timestamp(),'yyyy-MM-dd HH:mm:ss') etl_date
            from %(s_stg_net_flow_m)s t1
