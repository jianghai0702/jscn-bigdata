...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_other_download_m         				    =    "st_other_download_m"
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
...
##===========================================================================
#插入当前dwd全量数据
    hsql='''insert overwrite table %(t_st_other_download_m)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
            select
    		  %(ARG_OPTIME_LAST1_M)s cycle_id,
              t1.task_name,
              t1.monitor_operator operator,
              avg(t1.download_speed) transmission_speed,
              avg(t1.avg_download_time) transmission_time,
              avg(t1.avg_dns_query_time) dns_time,
              avg(t1.avg_tcp_connet_time) tcp_time,
              sum(t1.download_bytes) transmission_bytes,
