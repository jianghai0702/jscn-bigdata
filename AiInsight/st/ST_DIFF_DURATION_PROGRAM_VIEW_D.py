...
#-------------------------------------------------------------------------------
# Name: ST各时段各节目直播收视情况
# Pay: ST_DIFF_DURATION_PROGRAM_VIEW_D.py
# Purpose: 
# 
# Author:      wangxx
# 
...
# 源表声明
#-------------------------------------------------------------------------------
s_dwa_tv_diff_time_program_d                           =    "dwa_tv_diff_time_program_d"
...
# 目标表声明
#-------------------------------------------------------------------------------
t_st_diff_duration_program_view_d              =    "st_diff_duration_program_view_d"
# 开始数据处理
#-------------------------------------------------------------------------------
...
try:
    ...
    hsql='''
        insert overwrite table %(t_st_diff_duration_program_view_d)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
        SELECT a1.cycle_id,a1.own_corp_std_org_code,a1.own_corp_std_org_name,
               a3.std_channel_group_code,a3.std_channel_group_name,
               a1.std_channel_name,a1.program_name,
               a1.duration_id,a1.duration_name,
               a1.tv_time,
               a1.all_tv_time,
               a1.tv_user_count,
               ...
               a1.pro_begin_time,a1.pro_end_time,a1.program_type,a1.broad_type,a1.program_num,a1.pro_begin_minute_code,a1.pro_end_minute_code
        FROM 
        (SELECT t1.cycle_id
        ...
        FROM %(s_dwa_tv_diff_time_program_d)s AS t1 ,dim_std_duration AS t3
        ...
        GROUP BY t1.cycle_id,t1.own_corp_std_org_code,t1.own_corp_std_org_name,t1.std_channel_name,t1.program_name,t3.duration_id,t3.duration_name,t3.duration_times,t1.pro_begin_time,t1.pro_end_time,t1.program_type,t1.broad_type,t1.program_num,t1.pro_begin_minute_code,t1.pro_end_minute_code 
        )  AS a1
