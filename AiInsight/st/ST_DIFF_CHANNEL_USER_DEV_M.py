...
#-------------------------------------------------------------------------------
# Name: ST用户发展按渠道统计(月)
# Pay: ST_DIFF_CHANNEL_USER_DEV_M.py
# Purpose:
#
# Author:      liuzx
#
...
##===========================================================================     
    ...
    s_dim_std_cust_channel                    =    "dim_std_cust_channel"
##===========================================================================       
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_diff_channel_user_dev_m   				    =    "st_diff_channel_user_dev_m"
...
##===========================================================================
#生成目标表数据
    hsql='''insert overwrite table %(t_st_diff_channel_user_dev_m)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
            select
              ...
              '' area_std_addr_id,
              '' area_std_addr_name,
              t1.std_cust_channel_code,
              t3.std_cust_channel_name,
            ...
            left join %(s_dim_std_cust_channel)s t3 on t1.std_cust_channel_code=t3.std_cust_channel_code
            where t1.pt_mon=%(ARG_OPTIME_LAST1_M)s
            group by t1.own_corp_std_org_code,t2.std_org_name,t1.management_station,
                     t1.std_cust_channel_code,t3.std_cust_channel_name
            '''% vars()
