...
# Pay: ST_DIFF_DEVICE_CATE_USER_M.py
# Purpose:
#
# Author:      liuyf7
#
...
##自定义变量声明---源表声明                                                          
##===========================================================================
    s_dwa_diff_device_cate_user_d    =    "dwa_diff_device_cate_user_d"
    s_dwa_fact_ins_prod_mon          =    "dwa_fact_ins_prod_mon"
    s_dim_std_organize               =    "dim_std_organize"
##===========================================================================       
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_diff_device_cate_user_m     =    "st_diff_device_cate_user_m"
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
...
#生成目标表数据
    hsql='''insert overwrite table %(t_st_diff_device_cate_user_m)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
            select
              ...
              t4.std_org_name
            from %(s_dwa_diff_device_cate_user_d)s t1
            left join %(s_dwa_fact_ins_prod_mon)s t2
           ...
           group by t1.std_device_cate_code,
                    t1.std_device_cate_name,
                    t3.total_user_count,
                    t2.own_corp_std_org_code,
                    t4.std_org_name
