...
#-------------------------------------------------------------------------------
# Name: ST网页浏览分任务情况(月)
# Pay: ST_DIFF_TASK_WEB_BROWSE_M.py
# Purpose:
#
# Author:      lvdp
#
...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_diff_task_web_browse_m               =    "st_diff_task_web_browse_m"
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
...
##===========================================================================
#插入当前dwd全量数据
    hsql='''insert overwrite table %(t_st_diff_task_web_browse_m)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
            select
              %(ARG_OPTIME_LAST1_M)s cycle_id,
              t1.task_name,
              round(avg(t1.performance),2),
              round(avg(t1.first_screen_time),2) first_screen,
              round(avg(t1.avg_download_time),2) download_time,
