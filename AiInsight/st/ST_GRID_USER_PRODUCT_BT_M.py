...
# -*-coding:utf-8 -*-
#-------------------------------------------------------------------------------
# Name: ST网格用户发展产品计费类型统计
# Pay: ST_GRID_USER_PRODUCT_BT_M.py
# Purpose: 统计网格-小区存量、新增、流失用户产品计费类型订购情况
# 
# Author:      wangxx
# 
# Created:     2018-11-02
...
# 目标表声明
#-------------------------------------------------------------------------------
t_st_grid_user_product_bt_m                    =    "st_grid_user_product_bt_m"
...
try:
    ...
    hsql='''
        insert overwrite table %(t_st_grid_user_product_bt_m)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
        SELECT t.cycle_id,
