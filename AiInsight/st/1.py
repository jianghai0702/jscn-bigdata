...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_diff_offer_user_m                =    "st_diff_offer_user_m" 
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
#ST不同套餐不同网站类型用户

    hsql='''insert overwrite table %(t_st_diff_offer_user_m)s partition(pt_mon = %(ARG_OPTIME_LAST_M)s)
    select
    ...
    from %(s_dwa_diff_organize_user_m)s t1 
        ...
        group by t1.own_corp_std_org_code,OWN_CORP_STD_ORG_NAME,t3.OFFER_NAME
    '''% vars()
