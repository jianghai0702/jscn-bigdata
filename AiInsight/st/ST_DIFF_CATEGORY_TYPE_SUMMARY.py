...
#-------------------------------------------------------------------------------
# Name:ST不同栏目类型点播统计
# Pay:ST_DIFF_CATEGORY_TYPE_SUMMARY.py
# Purpose:
#
# Author:      zhangzc
#
...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_diff_category_type_summary              =    "st_diff_category_type_summary"
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
...
##===========================================================================
#生成 当天数据
    hsql='''insert overwrite table %(t_st_diff_category_type_summary)s PARTITION(pt_mon = %(ARG_OPTIME_LAST1_M)s)
     ...
     inner join %(s_dwd_vod_movie_master)s c
       on a.CONTENT_ID = c.MOVASSETID
      and c.pt_mon = %(ARG_OPTIME_LAST1_M)s
     inner join %(s_dwd_vod_category_master)s d
       on c.categoryid = d.categoryid
      and d.pt_mon = %(ARG_OPTIME_LAST1_M)s
     inner join %(s_dwd_vod_category_master)s e
       on d.parent_id = e.categoryid
      and e.pt_mon = %(ARG_OPTIME_LAST1_M)s
...
#生成 当月数据  地区级
    hsql='''insert into table %(t_st_diff_category_type_summary)s PARTITION(pt_mon = %(ARG_OPTIME_LAST1_M)s)       
...
from %(t_st_diff_category_type_summary)s a
