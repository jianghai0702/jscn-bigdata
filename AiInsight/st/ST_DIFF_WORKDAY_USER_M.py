...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_diff_workday_user_m               =    "st_diff_workday_user_m"        
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
#ST不同工作日类型访问用户
    hsql='''insert overwrite table %(t_st_diff_workday_user_m)s partition(pt_mon = %(ARG_OPTIME_LAST_M)s)
    select
       t1.own_corp_std_org_code        --标准归属分公司编码
       ,t1.own_corp_std_org_name       --标准归属分公司名称
       ,if(pmod(datediff('%(ARG_OPTIME_LASTDAY_ISO)s', '1920-01-01') - 3, 7)='0', 7, 
       pmod(datediff('%(ARG_OPTIME_LASTDAY_ISO)s', '1920-01-01') - 3, 7)) as workday_type   --工作日类型        
