...
## -*-coding:utf-8 -*-
#-------------------------------------------------------------------------------
# Name: ST视频观看质量分任务情况(月)
# Pay: ST_DIFF_TASK_VIDEO_VIEW_M.py
# Purpose:
#
# Author:      liuzx
#
...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_st_diff_task_video_view_m       				=    "st_diff_task_video_view_m"
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
...
##===========================================================================
#插入当前dwd全量数据
    hsql='''insert overwrite table %(t_st_diff_task_video_view_m)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
            select
