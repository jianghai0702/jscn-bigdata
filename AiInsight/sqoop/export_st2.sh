...
#su - hdfs <<EOF
sqoop_str="/usr/bin/sqoop  --options-file /AiInsight/sqoop/hive_export_swj.txt  --table "${rdbms_table_name}"  --hcatalog-database default --hcatalog-table "${hive_table_name}" "${partition_args}""
