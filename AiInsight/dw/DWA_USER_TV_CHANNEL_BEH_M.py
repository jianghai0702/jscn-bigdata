...
# -*-coding:utf-8 -*-
#-------------------------------------------------------------------------------
# Name:DWA用户直播频道行为标签月表
# Pay:DWA_USER_TV_CHANNEL_BEH_M.py
# Purpose:
#
# Author:      chens
#
...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_dwa_user_tv_channel_beh_m             =    "dwa_user_tv_channel_beh_m"      
##===========================================================================       
##创建临时表                                                        
##===========================================================================
...
##===========================================================================
#生成    当周期的记录；
    hsql='''insert overwrite table %(t_dwa_user_tv_channel_beh_m)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
            select
                t1.prod_inst_id,
                t2.cust_id,
                t1.channel_name,
                max(t1.tv_num) max_tv_num,
                round(avg(t1.tv_num),2) avg_tv_num,
            ...
            group by t1.prod_inst_id,t2.cust_id,t1.channel_name
          '''% vars()    
