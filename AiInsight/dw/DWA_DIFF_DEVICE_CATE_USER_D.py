...
#-------------------------------------------------------------------------------
# Name:DWA使用各设备的用户(日)
# Pay:DWA_DIFF_DEVICE_CATE_USER_D.py
# Purpose:
#
# Author:      liuyf7
#
...
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_dwa_diff_device_cate_user_d                =    "dwa_diff_device_cate_user_d"    
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
...
#插入当日各设备的访问用户
    hsql='''insert overwrite table %(t_dwa_diff_device_cate_user_d)s partition(pt_time=%(ARG_OPTIME_LASTDAY)s)
     select distinct std_device_cate_code
            ,std_device_cate_name
            ,remote_addr user_name
            ,from_unixtime(unix_timestamp(),'yyyy-MM-dd HH:mm:ss') etl_date
       from %(s_dwd_nginx_log)s
      where pt_time = %(ARG_OPTIME_LASTDAY)s --取当天数据
            '''% vars()
