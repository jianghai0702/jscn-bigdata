// ORM class for table 'st_diff_online_length_user_m'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Dec 18 18:36:15 CST 2018
...
public class st_diff_online_length_user_m extends SqoopRecord  implements DBWritable, Writable {
  ...
  public st_diff_online_length_user_m with_CYCLE_ID(String CYCLE_ID) {
    this.CYCLE_ID = CYCLE_ID;
    return this;
  }
  ...
  public st_diff_online_length_user_m with_STD_ONLINE_LENGTH_CODE(String STD_ONLINE_LENGTH_CODE) {
    this.STD_ONLINE_LENGTH_CODE = STD_ONLINE_LENGTH_CODE;
    return this;
  }
  ...
  public st_diff_online_length_user_m with_STD_ONLINE_LENGTH_NAME(String STD_ONLINE_LENGTH_NAME) {
    this.STD_ONLINE_LENGTH_NAME = STD_ONLINE_LENGTH_NAME;
    return this;
  }
  ...
  public st_diff_online_length_user_m with_USER_COUNT(java.math.BigDecimal USER_COUNT) {
    this.USER_COUNT = USER_COUNT;
    return this;
  }
  ...
  public st_diff_online_length_user_m with_USER_RATE(java.math.BigDecimal USER_RATE) {
    this.USER_RATE = USER_RATE;
    return this;
  }
  ...
  public st_diff_online_length_user_m with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  ...
  public st_diff_online_length_user_m with_OWN_CORP_STD_ORG_CODE(String OWN_CORP_STD_ORG_CODE) {
    this.OWN_CORP_STD_ORG_CODE = OWN_CORP_STD_ORG_CODE;
    return this;
  }
  ...
  public st_diff_online_length_user_m with_OWN_CORP_STD_ORG_NAME(String OWN_CORP_STD_ORG_NAME) {
    this.OWN_CORP_STD_ORG_NAME = OWN_CORP_STD_ORG_NAME;
    return this;
  }
  ...
  public st_diff_online_length_user_m with_PT_MON(String PT_MON) {
    this.PT_MON = PT_MON;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof st_diff_online_length_user_m)) {
      return false;
    }
    st_diff_online_length_user_m that = (st_diff_online_length_user_m) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.STD_ONLINE_LENGTH_CODE = JdbcWritableBridge.readString(2, __dbResults);
    this.STD_ONLINE_LENGTH_NAME = JdbcWritableBridge.readString(3, __dbResults);
    this.USER_COUNT = JdbcWritableBridge.readBigDecimal(4, __dbResults);
    this.USER_RATE = JdbcWritableBridge.readBigDecimal(5, __dbResults);
    this.ETL_DATE = JdbcWritableBridge.readTimestamp(6, __dbResults);
    this.OWN_CORP_STD_ORG_CODE = JdbcWritableBridge.readString(7, __dbResults);
    this.OWN_CORP_STD_ORG_NAME = JdbcWritableBridge.readString(8, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(STD_ONLINE_LENGTH_CODE, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(STD_ONLINE_LENGTH_NAME, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(USER_COUNT, 4 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(USER_RATE, 5 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeTimestamp(ETL_DATE, 6 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(OWN_CORP_STD_ORG_CODE, 7 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(OWN_CORP_STD_ORG_NAME, 8 + __off, 12, __dbStmt);
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    st_diff_online_length_user_m o = (st_diff_online_length_user_m) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(st_diff_online_length_user_m o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
