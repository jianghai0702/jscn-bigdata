// ORM class for table 'ST_DIFF_DEVICE_USER_M'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Apr 11 10:59:06 CST 2019
...
public class ST_DIFF_DEVICE_USER_M extends SqoopRecord  implements DBWritable, Writable {
  ...
  public ST_DIFF_DEVICE_USER_M with_OWN_CORP_STD_ORG_CODE(String OWN_CORP_STD_ORG_CODE) {
    this.OWN_CORP_STD_ORG_CODE = OWN_CORP_STD_ORG_CODE;
    return this;
  }
  ...
  public ST_DIFF_DEVICE_USER_M with_OWN_CORP_STD_ORG_NAME(String OWN_CORP_STD_ORG_NAME) {
    this.OWN_CORP_STD_ORG_NAME = OWN_CORP_STD_ORG_NAME;
    return this;
  }
  ...
  public ST_DIFF_DEVICE_USER_M with_STD_DEVICE_CATE_CODE(String STD_DEVICE_CATE_CODE) {
    this.STD_DEVICE_CATE_CODE = STD_DEVICE_CATE_CODE;
    return this;
  }
  ...
  public ST_DIFF_DEVICE_USER_M with_STD_DEVICE_CATE_NAME(String STD_DEVICE_CATE_NAME) {
    this.STD_DEVICE_CATE_NAME = STD_DEVICE_CATE_NAME;
    return this;
  }
  ...
  public ST_DIFF_DEVICE_USER_M with_VISIT_COUNT(java.math.BigDecimal VISIT_COUNT) {
    this.VISIT_COUNT = VISIT_COUNT;
    return this;
  }
  ...
  public ST_DIFF_DEVICE_USER_M with_VISIT_USER_COUNT(java.math.BigDecimal VISIT_USER_COUNT) {
    this.VISIT_USER_COUNT = VISIT_USER_COUNT;
    return this;
  }
  ...
  public ST_DIFF_DEVICE_USER_M with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  ...
  public ST_DIFF_DEVICE_USER_M with_PT_MON(String PT_MON) {
    this.PT_MON = PT_MON;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ST_DIFF_DEVICE_USER_M)) {
      return false;
    }
    ST_DIFF_DEVICE_USER_M that = (ST_DIFF_DEVICE_USER_M) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.STD_DEVICE_CATE_CODE = JdbcWritableBridge.readString(3, __dbResults);
    this.STD_DEVICE_CATE_NAME = JdbcWritableBridge.readString(4, __dbResults);
    this.VISIT_COUNT = JdbcWritableBridge.readBigDecimal(5, __dbResults);
    this.VISIT_USER_COUNT = JdbcWritableBridge.readBigDecimal(6, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(STD_DEVICE_CATE_CODE, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(STD_DEVICE_CATE_NAME, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(VISIT_COUNT, 5 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(VISIT_USER_COUNT, 6 + __off, 3, __dbStmt);
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    ST_DIFF_DEVICE_USER_M o = (ST_DIFF_DEVICE_USER_M) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(ST_DIFF_DEVICE_USER_M o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
