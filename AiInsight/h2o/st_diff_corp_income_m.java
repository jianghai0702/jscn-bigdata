// ORM class for table 'st_diff_corp_income_m'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Dec 18 18:43:48 CST 2018
...
public class st_diff_corp_income_m extends SqoopRecord  implements DBWritable, Writable {
  ...
  public st_diff_corp_income_m with_CYCLE_ID(String CYCLE_ID) {
    this.CYCLE_ID = CYCLE_ID;
    return this;
  }
  ...
  public st_diff_corp_income_m with_OWN_CORP_STD_ORG_CODE(String OWN_CORP_STD_ORG_CODE) {
    this.OWN_CORP_STD_ORG_CODE = OWN_CORP_STD_ORG_CODE;
    return this;
  }
  ...
  public st_diff_corp_income_m with_OWN_CORP_STD_ORG_NAME(String OWN_CORP_STD_ORG_NAME) {
    this.OWN_CORP_STD_ORG_NAME = OWN_CORP_STD_ORG_NAME;
    return this;
  }
  ...
  public st_diff_corp_income_m with_NEW_ORDER_USER_COUNT(java.math.BigDecimal NEW_ORDER_USER_COUNT) {
    this.NEW_ORDER_USER_COUNT = NEW_ORDER_USER_COUNT;
    return this;
  }
  ...
  public st_diff_corp_income_m with_NEW_ORDER_AMOUNT(java.math.BigDecimal NEW_ORDER_AMOUNT) {
    this.NEW_ORDER_AMOUNT = NEW_ORDER_AMOUNT;
    return this;
  }
  private java.math.BigDecimal NEW_ORDER_AMOUNT_CHAIN;
  public java.math.BigDecimal get_NEW_ORDER_AMOUNT_CHAIN() {
    return NEW_ORDER_AMOUNT_CHAIN;
  }
  public void set_NEW_ORDER_AMOUNT_CHAIN(java.math.BigDecimal NEW_ORDER_AMOUNT_CHAIN) {
    this.NEW_ORDER_AMOUNT_CHAIN = NEW_ORDER_AMOUNT_CHAIN;
  }
  public st_diff_corp_income_m with_NEW_ORDER_AMOUNT_CHAIN(java.math.BigDecimal NEW_ORDER_AMOUNT_CHAIN) {
    this.NEW_ORDER_AMOUNT_CHAIN = NEW_ORDER_AMOUNT_CHAIN;
    return this;
  }
  private java.math.BigDecimal NEW_ORDER_AMOUNT_EAR;
  public java.math.BigDecimal get_NEW_ORDER_AMOUNT_EAR() {
    return NEW_ORDER_AMOUNT_EAR;
  }
  public void set_NEW_ORDER_AMOUNT_EAR(java.math.BigDecimal NEW_ORDER_AMOUNT_EAR) {
    this.NEW_ORDER_AMOUNT_EAR = NEW_ORDER_AMOUNT_EAR;
  }
  public st_diff_corp_income_m with_NEW_ORDER_AMOUNT_EAR(java.math.BigDecimal NEW_ORDER_AMOUNT_EAR) {
    this.NEW_ORDER_AMOUNT_EAR = NEW_ORDER_AMOUNT_EAR;
    return this;
  }
  private java.math.BigDecimal NEW_ORDER_AMOUNT_CHAIN_GROWTH;
  public java.math.BigDecimal get_NEW_ORDER_AMOUNT_CHAIN_GROWTH() {
    return NEW_ORDER_AMOUNT_CHAIN_GROWTH;
  }
  public void set_NEW_ORDER_AMOUNT_CHAIN_GROWTH(java.math.BigDecimal NEW_ORDER_AMOUNT_CHAIN_GROWTH) {
    this.NEW_ORDER_AMOUNT_CHAIN_GROWTH = NEW_ORDER_AMOUNT_CHAIN_GROWTH;
  }
  public st_diff_corp_income_m with_NEW_ORDER_AMOUNT_CHAIN_GROWTH(java.math.BigDecimal NEW_ORDER_AMOUNT_CHAIN_GROWTH) {
    this.NEW_ORDER_AMOUNT_CHAIN_GROWTH = NEW_ORDER_AMOUNT_CHAIN_GROWTH;
    return this;
  }
  private java.math.BigDecimal NEW_ORDER_AMOUNT_EAR_GROWTH;
  public java.math.BigDecimal get_NEW_ORDER_AMOUNT_EAR_GROWTH() {
    return NEW_ORDER_AMOUNT_EAR_GROWTH;
  }
  public void set_NEW_ORDER_AMOUNT_EAR_GROWTH(java.math.BigDecimal NEW_ORDER_AMOUNT_EAR_GROWTH) {
    this.NEW_ORDER_AMOUNT_EAR_GROWTH = NEW_ORDER_AMOUNT_EAR_GROWTH;
  }
  public st_diff_corp_income_m with_NEW_ORDER_AMOUNT_EAR_GROWTH(java.math.BigDecimal NEW_ORDER_AMOUNT_EAR_GROWTH) {
    this.NEW_ORDER_AMOUNT_EAR_GROWTH = NEW_ORDER_AMOUNT_EAR_GROWTH;
    return this;
  }
  ...
  public st_diff_corp_income_m with_NEW_ORDER_AMOUNT_ARPU(java.math.BigDecimal NEW_ORDER_AMOUNT_ARPU) {
    this.NEW_ORDER_AMOUNT_ARPU = NEW_ORDER_AMOUNT_ARPU;
    return this;
  }
  ...
  public st_diff_corp_income_m with_NEW_ORDER_AMOUNT_NOT0_ARPU(java.math.BigDecimal NEW_ORDER_AMOUNT_NOT0_ARPU) {
    this.NEW_ORDER_AMOUNT_NOT0_ARPU = NEW_ORDER_AMOUNT_NOT0_ARPU;
    return this;
  }
  ...
  public st_diff_corp_income_m with_BILL_USER_COUNT(java.math.BigDecimal BILL_USER_COUNT) {
    this.BILL_USER_COUNT = BILL_USER_COUNT;
    return this;
  }
  ...
  public st_diff_corp_income_m with_BILL_AMOUNT(java.math.BigDecimal BILL_AMOUNT) {
    this.BILL_AMOUNT = BILL_AMOUNT;
    return this;
  }
  private java.math.BigDecimal BILL_AMOUNT_CHAIN;
  public java.math.BigDecimal get_BILL_AMOUNT_CHAIN() {
    return BILL_AMOUNT_CHAIN;
  }
  public void set_BILL_AMOUNT_CHAIN(java.math.BigDecimal BILL_AMOUNT_CHAIN) {
    this.BILL_AMOUNT_CHAIN = BILL_AMOUNT_CHAIN;
  }
  public st_diff_corp_income_m with_BILL_AMOUNT_CHAIN(java.math.BigDecimal BILL_AMOUNT_CHAIN) {
    this.BILL_AMOUNT_CHAIN = BILL_AMOUNT_CHAIN;
    return this;
  }
  private java.math.BigDecimal BILL_AMOUNT_EAR;
  public java.math.BigDecimal get_BILL_AMOUNT_EAR() {
    return BILL_AMOUNT_EAR;
  }
  public void set_BILL_AMOUNT_EAR(java.math.BigDecimal BILL_AMOUNT_EAR) {
    this.BILL_AMOUNT_EAR = BILL_AMOUNT_EAR;
  }
  public st_diff_corp_income_m with_BILL_AMOUNT_EAR(java.math.BigDecimal BILL_AMOUNT_EAR) {
    this.BILL_AMOUNT_EAR = BILL_AMOUNT_EAR;
    return this;
  }
  ...
  public st_diff_corp_income_m with_BILL_AMOUNT_ARPU(java.math.BigDecimal BILL_AMOUNT_ARPU) {
    this.BILL_AMOUNT_ARPU = BILL_AMOUNT_ARPU;
    return this;
  }
  private java.math.BigDecimal LAN_PARTNER_AMOUNT;
  public java.math.BigDecimal get_LAN_PARTNER_AMOUNT() {
    return LAN_PARTNER_AMOUNT;
  }
  public void set_LAN_PARTNER_AMOUNT(java.math.BigDecimal LAN_PARTNER_AMOUNT) {
    this.LAN_PARTNER_AMOUNT = LAN_PARTNER_AMOUNT;
  }
  public st_diff_corp_income_m with_LAN_PARTNER_AMOUNT(java.math.BigDecimal LAN_PARTNER_AMOUNT) {
    this.LAN_PARTNER_AMOUNT = LAN_PARTNER_AMOUNT;
    return this;
  }
  ...
  public st_diff_corp_income_m with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  ...
  public st_diff_corp_income_m with_PT_MON(String PT_MON) {
    this.PT_MON = PT_MON;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof st_diff_corp_income_m)) {
      return false;
    }
    st_diff_corp_income_m that = (st_diff_corp_income_m) o;
    boolean equal = true;
    ...
    equal = equal && (this.NEW_ORDER_AMOUNT_CHAIN == null ? that.NEW_ORDER_AMOUNT_CHAIN == null : this.NEW_ORDER_AMOUNT_CHAIN.equals(that.NEW_ORDER_AMOUNT_CHAIN));
    equal = equal && (this.NEW_ORDER_AMOUNT_EAR == null ? that.NEW_ORDER_AMOUNT_EAR == null : this.NEW_ORDER_AMOUNT_EAR.equals(that.NEW_ORDER_AMOUNT_EAR));
    equal = equal && (this.NEW_ORDER_AMOUNT_CHAIN_GROWTH == null ? that.NEW_ORDER_AMOUNT_CHAIN_GROWTH == null : this.NEW_ORDER_AMOUNT_CHAIN_GROWTH.equals(that.NEW_ORDER_AMOUNT_CHAIN_GROWTH));
    equal = equal && (this.NEW_ORDER_AMOUNT_EAR_GROWTH == null ? that.NEW_ORDER_AMOUNT_EAR_GROWTH == null : this.NEW_ORDER_AMOUNT_EAR_GROWTH.equals(that.NEW_ORDER_AMOUNT_EAR_GROWTH));
    ...
    equal = equal && (this.BILL_AMOUNT_CHAIN == null ? that.BILL_AMOUNT_CHAIN == null : this.BILL_AMOUNT_CHAIN.equals(that.BILL_AMOUNT_CHAIN));
    equal = equal && (this.BILL_AMOUNT_EAR == null ? that.BILL_AMOUNT_EAR == null : this.BILL_AMOUNT_EAR.equals(that.BILL_AMOUNT_EAR));
    equal = equal && (this.BILL_AMOUNT_ARPU == null ? that.BILL_AMOUNT_ARPU == null : this.BILL_AMOUNT_ARPU.equals(that.BILL_AMOUNT_ARPU));
    equal = equal && (this.LAN_PARTNER_AMOUNT == null ? that.LAN_PARTNER_AMOUNT == null : this.LAN_PARTNER_AMOUNT.equals(that.LAN_PARTNER_AMOUNT));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.NEW_ORDER_USER_COUNT = JdbcWritableBridge.readBigDecimal(4, __dbResults);
    this.NEW_ORDER_AMOUNT = JdbcWritableBridge.readBigDecimal(5, __dbResults);
    this.NEW_ORDER_AMOUNT_CHAIN = JdbcWritableBridge.readBigDecimal(6, __dbResults);
    this.NEW_ORDER_AMOUNT_EAR = JdbcWritableBridge.readBigDecimal(7, __dbResults);
    this.NEW_ORDER_AMOUNT_CHAIN_GROWTH = JdbcWritableBridge.readBigDecimal(8, __dbResults);
    this.NEW_ORDER_AMOUNT_EAR_GROWTH = JdbcWritableBridge.readBigDecimal(9, __dbResults);
    ...
    this.BILL_AMOUNT_CHAIN = JdbcWritableBridge.readBigDecimal(14, __dbResults);
    this.BILL_AMOUNT_EAR = JdbcWritableBridge.readBigDecimal(15, __dbResults);
    this.BILL_AMOUNT_ARPU = JdbcWritableBridge.readBigDecimal(16, __dbResults);
    this.LAN_PARTNER_AMOUNT = JdbcWritableBridge.readBigDecimal(17, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeBigDecimal(NEW_ORDER_USER_COUNT, 4 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(NEW_ORDER_AMOUNT, 5 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(NEW_ORDER_AMOUNT_CHAIN, 6 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(NEW_ORDER_AMOUNT_EAR, 7 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(NEW_ORDER_AMOUNT_CHAIN_GROWTH, 8 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(NEW_ORDER_AMOUNT_EAR_GROWTH, 9 + __off, 3, __dbStmt);
    ...
    JdbcWritableBridge.writeBigDecimal(BILL_AMOUNT_CHAIN, 14 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(BILL_AMOUNT_EAR, 15 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(BILL_AMOUNT_ARPU, 16 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(LAN_PARTNER_AMOUNT, 17 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeTimestamp(ETL_DATE, 18 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(PT_MON, 19 + __off, 1, __dbStmt);
    return 19;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.NEW_ORDER_AMOUNT_CHAIN = null;
    } else {
    this.NEW_ORDER_AMOUNT_CHAIN = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.NEW_ORDER_AMOUNT_EAR = null;
    } else {
    this.NEW_ORDER_AMOUNT_EAR = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.NEW_ORDER_AMOUNT_CHAIN_GROWTH = null;
    } else {
    this.NEW_ORDER_AMOUNT_CHAIN_GROWTH = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.NEW_ORDER_AMOUNT_EAR_GROWTH = null;
    } else {
    this.NEW_ORDER_AMOUNT_EAR_GROWTH = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
    ...
    if (__dataIn.readBoolean()) { 
        this.BILL_AMOUNT_CHAIN = null;
    } else {
    this.BILL_AMOUNT_CHAIN = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.BILL_AMOUNT_EAR = null;
    } else {
    this.BILL_AMOUNT_EAR = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
    ...
    if (__dataIn.readBoolean()) { 
        this.LAN_PARTNER_AMOUNT = null;
    } else {
    this.LAN_PARTNER_AMOUNT = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.ETL_DATE = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.NEW_ORDER_AMOUNT_CHAIN) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.NEW_ORDER_AMOUNT_CHAIN, __dataOut);
    }
    if (null == this.NEW_ORDER_AMOUNT_EAR) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.NEW_ORDER_AMOUNT_EAR, __dataOut);
    }
    if (null == this.NEW_ORDER_AMOUNT_CHAIN_GROWTH) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.NEW_ORDER_AMOUNT_CHAIN_GROWTH, __dataOut);
    }
    if (null == this.NEW_ORDER_AMOUNT_EAR_GROWTH) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.NEW_ORDER_AMOUNT_EAR_GROWTH, __dataOut);
    }
    ...
    if (null == this.BILL_AMOUNT_CHAIN) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.BILL_AMOUNT_CHAIN, __dataOut);
    }
    if (null == this.BILL_AMOUNT_EAR) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.BILL_AMOUNT_EAR, __dataOut);
    }
    ...
    if (null == this.LAN_PARTNER_AMOUNT) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.LAN_PARTNER_AMOUNT, __dataOut);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(NEW_ORDER_AMOUNT_CHAIN==null?"null":NEW_ORDER_AMOUNT_CHAIN.toPlainString(), delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(NEW_ORDER_AMOUNT_EAR==null?"null":NEW_ORDER_AMOUNT_EAR.toPlainString(), delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(NEW_ORDER_AMOUNT_CHAIN_GROWTH==null?"null":NEW_ORDER_AMOUNT_CHAIN_GROWTH.toPlainString(), delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(NEW_ORDER_AMOUNT_EAR_GROWTH==null?"null":NEW_ORDER_AMOUNT_EAR_GROWTH.toPlainString(), delimiters));
    __sb.append(fieldDelim);
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(BILL_AMOUNT_CHAIN==null?"null":BILL_AMOUNT_CHAIN.toPlainString(), delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(BILL_AMOUNT_EAR==null?"null":BILL_AMOUNT_EAR.toPlainString(), delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(BILL_AMOUNT_ARPU==null?"null":BILL_AMOUNT_ARPU.toPlainString(), delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(LAN_PARTNER_AMOUNT==null?"null":LAN_PARTNER_AMOUNT.toPlainString(), delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.NEW_ORDER_AMOUNT_CHAIN = null; } else {
      this.NEW_ORDER_AMOUNT_CHAIN = new java.math.BigDecimal(__cur_str);
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.NEW_ORDER_AMOUNT_EAR = null; } else {
      this.NEW_ORDER_AMOUNT_EAR = new java.math.BigDecimal(__cur_str);
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.NEW_ORDER_AMOUNT_CHAIN_GROWTH = null; } else {
      this.NEW_ORDER_AMOUNT_CHAIN_GROWTH = new java.math.BigDecimal(__cur_str);
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.NEW_ORDER_AMOUNT_EAR_GROWTH = null; } else {
      this.NEW_ORDER_AMOUNT_EAR_GROWTH = new java.math.BigDecimal(__cur_str);
    }
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.BILL_AMOUNT_CHAIN = null; } else {
      this.BILL_AMOUNT_CHAIN = new java.math.BigDecimal(__cur_str);
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.BILL_AMOUNT_EAR = null; } else {
      this.BILL_AMOUNT_EAR = new java.math.BigDecimal(__cur_str);
    }
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.LAN_PARTNER_AMOUNT = null; } else {
      this.LAN_PARTNER_AMOUNT = new java.math.BigDecimal(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    st_diff_corp_income_m o = (st_diff_corp_income_m) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(st_diff_corp_income_m o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("NEW_ORDER_AMOUNT_CHAIN", this.NEW_ORDER_AMOUNT_CHAIN);
    __sqoop$field_map.put("NEW_ORDER_AMOUNT_EAR", this.NEW_ORDER_AMOUNT_EAR);
    __sqoop$field_map.put("NEW_ORDER_AMOUNT_CHAIN_GROWTH", this.NEW_ORDER_AMOUNT_CHAIN_GROWTH);
    __sqoop$field_map.put("NEW_ORDER_AMOUNT_EAR_GROWTH", this.NEW_ORDER_AMOUNT_EAR_GROWTH);
    ...
    __sqoop$field_map.put("BILL_AMOUNT_CHAIN", this.BILL_AMOUNT_CHAIN);
    __sqoop$field_map.put("BILL_AMOUNT_EAR", this.BILL_AMOUNT_EAR);
    __sqoop$field_map.put("BILL_AMOUNT_ARPU", this.BILL_AMOUNT_ARPU);
    __sqoop$field_map.put("LAN_PARTNER_AMOUNT", this.LAN_PARTNER_AMOUNT);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("NEW_ORDER_AMOUNT_CHAIN".equals(__fieldName)) {
      this.NEW_ORDER_AMOUNT_CHAIN = (java.math.BigDecimal) __fieldVal;
    }
    else    if ("NEW_ORDER_AMOUNT_EAR".equals(__fieldName)) {
      this.NEW_ORDER_AMOUNT_EAR = (java.math.BigDecimal) __fieldVal;
    }
    else    if ("NEW_ORDER_AMOUNT_CHAIN_GROWTH".equals(__fieldName)) {
      this.NEW_ORDER_AMOUNT_CHAIN_GROWTH = (java.math.BigDecimal) __fieldVal;
    }
    else    if ("NEW_ORDER_AMOUNT_EAR_GROWTH".equals(__fieldName)) {
      this.NEW_ORDER_AMOUNT_EAR_GROWTH = (java.math.BigDecimal) __fieldVal;
    }
    ...
    else    if ("BILL_AMOUNT_CHAIN".equals(__fieldName)) {
      this.BILL_AMOUNT_CHAIN = (java.math.BigDecimal) __fieldVal;
    }
    else    if ("BILL_AMOUNT_EAR".equals(__fieldName)) {
      this.BILL_AMOUNT_EAR = (java.math.BigDecimal) __fieldVal;
    }
    else    if ("BILL_AMOUNT_ARPU".equals(__fieldName)) {
      this.BILL_AMOUNT_ARPU = (java.math.BigDecimal) __fieldVal;
    }
    else    if ("LAN_PARTNER_AMOUNT".equals(__fieldName)) {
      this.LAN_PARTNER_AMOUNT = (java.math.BigDecimal) __fieldVal;
    }
