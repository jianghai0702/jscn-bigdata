// ORM class for table 'ST_DR_MOVIE_PRODUCED_SUMMARY'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 13 19:35:11 CST 2018
...
public class ST_DR_MOVIE_PRODUCED_SUMMARY extends SqoopRecord  implements DBWritable, Writable {
  ...
  public ST_DR_MOVIE_PRODUCED_SUMMARY with_CYCLE_ID(String CYCLE_ID) {
    this.CYCLE_ID = CYCLE_ID;
    return this;
  }
  ...
  public ST_DR_MOVIE_PRODUCED_SUMMARY with_OWN_CORP_STD_ORG_CODE(String OWN_CORP_STD_ORG_CODE) {
    this.OWN_CORP_STD_ORG_CODE = OWN_CORP_STD_ORG_CODE;
    return this;
  }
  ...
  public ST_DR_MOVIE_PRODUCED_SUMMARY with_OWN_CORP_STD_ORG_NAME(String OWN_CORP_STD_ORG_NAME) {
    this.OWN_CORP_STD_ORG_NAME = OWN_CORP_STD_ORG_NAME;
    return this;
  }
  ...
  public void set_produced(String produced) {
    this.produced = produced;
  }
  public ST_DR_MOVIE_PRODUCED_SUMMARY with_produced(String produced) {
    this.produced = produced;
    return this;
  }
  ...
  public ST_DR_MOVIE_PRODUCED_SUMMARY with_dr_USER_COUNT(java.math.BigDecimal dr_USER_COUNT) {
    this.dr_USER_COUNT = dr_USER_COUNT;
    return this;
  }
  ...
  public ST_DR_MOVIE_PRODUCED_SUMMARY with_dr_count(java.math.BigDecimal dr_count) {
    this.dr_count = dr_count;
    return this;
  }
  ...
  public ST_DR_MOVIE_PRODUCED_SUMMARY with_lb_USER_COUNT(java.math.BigDecimal lb_USER_COUNT) {
    this.lb_USER_COUNT = lb_USER_COUNT;
    return this;
  }
  ...
  public ST_DR_MOVIE_PRODUCED_SUMMARY with_lb_count(java.math.BigDecimal lb_count) {
    this.lb_count = lb_count;
    return this;
  }
  ...
  public ST_DR_MOVIE_PRODUCED_SUMMARY with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  ...
  public ST_DR_MOVIE_PRODUCED_SUMMARY with_pt_mon(String pt_mon) {
    this.pt_mon = pt_mon;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ST_DR_MOVIE_PRODUCED_SUMMARY)) {
      return false;
    }
    ST_DR_MOVIE_PRODUCED_SUMMARY that = (ST_DR_MOVIE_PRODUCED_SUMMARY) o;
    boolean equal = true;
    ...
    equal = equal && (this.produced == null ? that.produced == null : this.produced.equals(that.produced));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.produced = JdbcWritableBridge.readString(4, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(produced, 4 + __off, 12, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.produced = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.produced) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, produced);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(produced==null?"null":produced, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.produced = null; } else {
      this.produced = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    ST_DR_MOVIE_PRODUCED_SUMMARY o = (ST_DR_MOVIE_PRODUCED_SUMMARY) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(ST_DR_MOVIE_PRODUCED_SUMMARY o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("produced", this.produced);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("produced".equals(__fieldName)) {
      this.produced = (String) __fieldVal;
    }
