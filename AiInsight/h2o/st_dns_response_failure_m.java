// ORM class for table 'st_dns_response_failure_m'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Dec 18 18:50:01 CST 2018
...
public class st_dns_response_failure_m extends SqoopRecord  implements DBWritable, Writable {
  ...
  public st_dns_response_failure_m with_OWN_CORP_STD_ORG_CODE(String OWN_CORP_STD_ORG_CODE) {
    this.OWN_CORP_STD_ORG_CODE = OWN_CORP_STD_ORG_CODE;
    return this;
  }
  ...
  public st_dns_response_failure_m with_OWN_CORP_STD_ORG_NAME(String OWN_CORP_STD_ORG_NAME) {
    this.OWN_CORP_STD_ORG_NAME = OWN_CORP_STD_ORG_NAME;
    return this;
  }
  ...
  public st_dns_response_failure_m with_ANSWER_CODE(String ANSWER_CODE) {
    this.ANSWER_CODE = ANSWER_CODE;
    return this;
  }
  private String ANSWER_NAME;
  public String get_ANSWER_NAME() {
    return ANSWER_NAME;
  }
  public void set_ANSWER_NAME(String ANSWER_NAME) {
    this.ANSWER_NAME = ANSWER_NAME;
  }
  public st_dns_response_failure_m with_ANSWER_NAME(String ANSWER_NAME) {
    this.ANSWER_NAME = ANSWER_NAME;
    return this;
  }
  private java.math.BigDecimal RESPONSE_COUNT;
  public java.math.BigDecimal get_RESPONSE_COUNT() {
    return RESPONSE_COUNT;
  }
  public void set_RESPONSE_COUNT(java.math.BigDecimal RESPONSE_COUNT) {
    this.RESPONSE_COUNT = RESPONSE_COUNT;
  }
  public st_dns_response_failure_m with_RESPONSE_COUNT(java.math.BigDecimal RESPONSE_COUNT) {
    this.RESPONSE_COUNT = RESPONSE_COUNT;
    return this;
  }
  ...
  public st_dns_response_failure_m with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  ...
  public st_dns_response_failure_m with_PT_MON(String PT_MON) {
    this.PT_MON = PT_MON;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof st_dns_response_failure_m)) {
      return false;
    }
    st_dns_response_failure_m that = (st_dns_response_failure_m) o;
    boolean equal = true;
    ...
    equal = equal && (this.ANSWER_CODE == null ? that.ANSWER_CODE == null : this.ANSWER_CODE.equals(that.ANSWER_CODE));
    equal = equal && (this.ANSWER_NAME == null ? that.ANSWER_NAME == null : this.ANSWER_NAME.equals(that.ANSWER_NAME));
    equal = equal && (this.RESPONSE_COUNT == null ? that.RESPONSE_COUNT == null : this.RESPONSE_COUNT.equals(that.RESPONSE_COUNT));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.ANSWER_CODE = JdbcWritableBridge.readString(3, __dbResults);
    this.ANSWER_NAME = JdbcWritableBridge.readString(4, __dbResults);
    this.RESPONSE_COUNT = JdbcWritableBridge.readBigDecimal(5, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(ANSWER_CODE, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(ANSWER_NAME, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(RESPONSE_COUNT, 5 + __off, 3, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.ANSWER_CODE = null;
    } else {
    this.ANSWER_CODE = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.ANSWER_NAME = null;
    } else {
    this.ANSWER_NAME = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.RESPONSE_COUNT = null;
    } else {
    this.RESPONSE_COUNT = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.ETL_DATE = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.ANSWER_CODE) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, ANSWER_CODE);
    }
    if (null == this.ANSWER_NAME) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, ANSWER_NAME);
    }
    if (null == this.RESPONSE_COUNT) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.RESPONSE_COUNT, __dataOut);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(ANSWER_CODE==null?"null":ANSWER_CODE, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(ANSWER_NAME==null?"null":ANSWER_NAME, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(RESPONSE_COUNT==null?"null":RESPONSE_COUNT.toPlainString(), delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.ANSWER_CODE = null; } else {
      this.ANSWER_CODE = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.ANSWER_NAME = null; } else {
      this.ANSWER_NAME = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.RESPONSE_COUNT = null; } else {
      this.RESPONSE_COUNT = new java.math.BigDecimal(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    st_dns_response_failure_m o = (st_dns_response_failure_m) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(st_dns_response_failure_m o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("ANSWER_CODE", this.ANSWER_CODE);
    __sqoop$field_map.put("ANSWER_NAME", this.ANSWER_NAME);
    __sqoop$field_map.put("RESPONSE_COUNT", this.RESPONSE_COUNT);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("ANSWER_CODE".equals(__fieldName)) {
      this.ANSWER_CODE = (String) __fieldVal;
    }
    else    if ("ANSWER_NAME".equals(__fieldName)) {
      this.ANSWER_NAME = (String) __fieldVal;
    }
    else    if ("RESPONSE_COUNT".equals(__fieldName)) {
      this.RESPONSE_COUNT = (java.math.BigDecimal) __fieldVal;
    }
