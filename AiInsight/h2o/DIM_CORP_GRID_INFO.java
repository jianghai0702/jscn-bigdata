...
//
// Debug information:
// Generated date: Fri Jul 05 13:59:23 CST 2019
...
public class DIM_CORP_GRID_INFO extends SqoopRecord  implements DBWritable, Writable {
  ...
  public DIM_CORP_GRID_INFO with_AREA_STD_ADDR_ID(String AREA_STD_ADDR_ID) {
    this.AREA_STD_ADDR_ID = AREA_STD_ADDR_ID;
    return this;
  }
  ...
  public DIM_CORP_GRID_INFO with_AREA_STD_ADDR_NAME(String AREA_STD_ADDR_NAME) {
    this.AREA_STD_ADDR_NAME = AREA_STD_ADDR_NAME;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.AREA_STD_ADDR_ID = JdbcWritableBridge.readString(4, __dbResults);
    this.AREA_STD_ADDR_NAME = JdbcWritableBridge.readString(5, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(AREA_STD_ADDR_ID, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(AREA_STD_ADDR_NAME, 5 + __off, 12, __dbStmt);
