// ORM class for table 'st_auth_rate_m'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Dec 18 18:42:10 CST 2018
...
public class st_auth_rate_m extends SqoopRecord  implements DBWritable, Writable {
  ...
  public st_auth_rate_m with_CYCLE_ID(java.math.BigDecimal CYCLE_ID) {
    this.CYCLE_ID = CYCLE_ID;
    return this;
  }
  ...
  public st_auth_rate_m with_OWN_CORP_STD_ORG_CODE(String OWN_CORP_STD_ORG_CODE) {
    this.OWN_CORP_STD_ORG_CODE = OWN_CORP_STD_ORG_CODE;
    return this;
  }
  ...
  public st_auth_rate_m with_OWN_CORP_STD_ORG_NAME(String OWN_CORP_STD_ORG_NAME) {
    this.OWN_CORP_STD_ORG_NAME = OWN_CORP_STD_ORG_NAME;
    return this;
  }
  private java.math.BigDecimal AUTH_SUCCESS_USER_COUNT;
  public java.math.BigDecimal get_AUTH_SUCCESS_USER_COUNT() {
    return AUTH_SUCCESS_USER_COUNT;
  }
  public void set_AUTH_SUCCESS_USER_COUNT(java.math.BigDecimal AUTH_SUCCESS_USER_COUNT) {
    this.AUTH_SUCCESS_USER_COUNT = AUTH_SUCCESS_USER_COUNT;
  }
  public st_auth_rate_m with_AUTH_SUCCESS_USER_COUNT(java.math.BigDecimal AUTH_SUCCESS_USER_COUNT) {
    this.AUTH_SUCCESS_USER_COUNT = AUTH_SUCCESS_USER_COUNT;
    return this;
  }
  ...
  public st_auth_rate_m with_AUTH_FAILURE_USER_COUNT(java.math.BigDecimal AUTH_FAILURE_USER_COUNT) {
    this.AUTH_FAILURE_USER_COUNT = AUTH_FAILURE_USER_COUNT;
    return this;
  }
  ...
  public st_auth_rate_m with_AUTH_SUCCESS_RATE(java.math.BigDecimal AUTH_SUCCESS_RATE) {
    this.AUTH_SUCCESS_RATE = AUTH_SUCCESS_RATE;
    return this;
  }
  ...
  public st_auth_rate_m with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  ...
  public st_auth_rate_m with_PT_MON(String PT_MON) {
    this.PT_MON = PT_MON;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof st_auth_rate_m)) {
      return false;
    }
    st_auth_rate_m that = (st_auth_rate_m) o;
    boolean equal = true;
    ...
    equal = equal && (this.AUTH_SUCCESS_USER_COUNT == null ? that.AUTH_SUCCESS_USER_COUNT == null : this.AUTH_SUCCESS_USER_COUNT.equals(that.AUTH_SUCCESS_USER_COUNT));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.AUTH_SUCCESS_USER_COUNT = JdbcWritableBridge.readBigDecimal(4, __dbResults);
    this.AUTH_FAILURE_USER_COUNT = JdbcWritableBridge.readBigDecimal(5, __dbResults);
    this.AUTH_SUCCESS_RATE = JdbcWritableBridge.readBigDecimal(6, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeBigDecimal(AUTH_SUCCESS_USER_COUNT, 4 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(AUTH_FAILURE_USER_COUNT, 5 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(AUTH_SUCCESS_RATE, 6 + __off, 3, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.AUTH_SUCCESS_USER_COUNT = null;
    } else {
    this.AUTH_SUCCESS_USER_COUNT = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.AUTH_SUCCESS_USER_COUNT) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.AUTH_SUCCESS_USER_COUNT, __dataOut);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(AUTH_SUCCESS_USER_COUNT==null?"null":AUTH_SUCCESS_USER_COUNT.toPlainString(), delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.AUTH_SUCCESS_USER_COUNT = null; } else {
      this.AUTH_SUCCESS_USER_COUNT = new java.math.BigDecimal(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    st_auth_rate_m o = (st_auth_rate_m) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(st_auth_rate_m o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("AUTH_SUCCESS_USER_COUNT", this.AUTH_SUCCESS_USER_COUNT);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("AUTH_SUCCESS_USER_COUNT".equals(__fieldName)) {
      this.AUTH_SUCCESS_USER_COUNT = (java.math.BigDecimal) __fieldVal;
    }
