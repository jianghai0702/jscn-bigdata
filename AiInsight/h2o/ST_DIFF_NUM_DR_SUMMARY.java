// ORM class for table 'ST_DIFF_NUM_DR_SUMMARY'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Wed Dec 12 15:33:12 CST 2018
...
public class ST_DIFF_NUM_DR_SUMMARY extends SqoopRecord  implements DBWritable, Writable {
  ...
  public ST_DIFF_NUM_DR_SUMMARY with_OWN_CORP_STD_ORG_CODE(String OWN_CORP_STD_ORG_CODE) {
    this.OWN_CORP_STD_ORG_CODE = OWN_CORP_STD_ORG_CODE;
    return this;
  }
  ...
  public ST_DIFF_NUM_DR_SUMMARY with_OWN_CORP_STD_ORG_NAME(String OWN_CORP_STD_ORG_NAME) {
    this.OWN_CORP_STD_ORG_NAME = OWN_CORP_STD_ORG_NAME;
    return this;
  }
  private String DR_COUNT_TYPE;
  public String get_DR_COUNT_TYPE() {
    return DR_COUNT_TYPE;
  }
  public void set_DR_COUNT_TYPE(String DR_COUNT_TYPE) {
    this.DR_COUNT_TYPE = DR_COUNT_TYPE;
  }
  public ST_DIFF_NUM_DR_SUMMARY with_DR_COUNT_TYPE(String DR_COUNT_TYPE) {
    this.DR_COUNT_TYPE = DR_COUNT_TYPE;
    return this;
  }
  ...
  public ST_DIFF_NUM_DR_SUMMARY with_DR_USER_COUNT(java.math.BigDecimal DR_USER_COUNT) {
    this.DR_USER_COUNT = DR_USER_COUNT;
    return this;
  }
  ...
  public ST_DIFF_NUM_DR_SUMMARY with_LB_USER_COUNT(java.math.BigDecimal LB_USER_COUNT) {
    this.LB_USER_COUNT = LB_USER_COUNT;
    return this;
  }
  ...
  public ST_DIFF_NUM_DR_SUMMARY with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  ...
  public ST_DIFF_NUM_DR_SUMMARY with_PT_MON(String PT_MON) {
    this.PT_MON = PT_MON;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ST_DIFF_NUM_DR_SUMMARY)) {
      return false;
    }
    ST_DIFF_NUM_DR_SUMMARY that = (ST_DIFF_NUM_DR_SUMMARY) o;
    boolean equal = true;
    ...
    equal = equal && (this.DR_COUNT_TYPE == null ? that.DR_COUNT_TYPE == null : this.DR_COUNT_TYPE.equals(that.DR_COUNT_TYPE));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.DR_COUNT_TYPE = JdbcWritableBridge.readString(3, __dbResults);
    this.DR_USER_COUNT = JdbcWritableBridge.readBigDecimal(4, __dbResults);
    this.LB_USER_COUNT = JdbcWritableBridge.readBigDecimal(5, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(DR_COUNT_TYPE, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(DR_USER_COUNT, 4 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(LB_USER_COUNT, 5 + __off, 3, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.DR_COUNT_TYPE = null;
    } else {
    this.DR_COUNT_TYPE = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.DR_COUNT_TYPE) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, DR_COUNT_TYPE);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(DR_COUNT_TYPE==null?"null":DR_COUNT_TYPE, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.DR_COUNT_TYPE = null; } else {
      this.DR_COUNT_TYPE = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    ST_DIFF_NUM_DR_SUMMARY o = (ST_DIFF_NUM_DR_SUMMARY) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(ST_DIFF_NUM_DR_SUMMARY o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("DR_COUNT_TYPE", this.DR_COUNT_TYPE);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("DR_COUNT_TYPE".equals(__fieldName)) {
      this.DR_COUNT_TYPE = (String) __fieldVal;
    }
