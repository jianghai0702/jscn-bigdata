// ORM class for table 'st_diff_bandwidth_income_m'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Dec 18 18:32:47 CST 2018
...
public class st_diff_bandwidth_income_m extends SqoopRecord  implements DBWritable, Writable {
  ...
  public st_diff_bandwidth_income_m with_CYCLE_ID(String CYCLE_ID) {
    this.CYCLE_ID = CYCLE_ID;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_OWN_CORP_STD_ORG_CODE(String OWN_CORP_STD_ORG_CODE) {
    this.OWN_CORP_STD_ORG_CODE = OWN_CORP_STD_ORG_CODE;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_OWN_CORP_STD_ORG_NAME(String OWN_CORP_STD_ORG_NAME) {
    this.OWN_CORP_STD_ORG_NAME = OWN_CORP_STD_ORG_NAME;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_STD_BANDWIDTH_CODE(String STD_BANDWIDTH_CODE) {
    this.STD_BANDWIDTH_CODE = STD_BANDWIDTH_CODE;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_STD_BANDWIDTH_NAME(String STD_BANDWIDTH_NAME) {
    this.STD_BANDWIDTH_NAME = STD_BANDWIDTH_NAME;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_NEW_ORDER_USER_COUNT(java.math.BigDecimal NEW_ORDER_USER_COUNT) {
    this.NEW_ORDER_USER_COUNT = NEW_ORDER_USER_COUNT;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_NEW_ORDER_AMOUNT(java.math.BigDecimal NEW_ORDER_AMOUNT) {
    this.NEW_ORDER_AMOUNT = NEW_ORDER_AMOUNT;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_NEW_ORDER_AMOUNT_ARPU(java.math.BigDecimal NEW_ORDER_AMOUNT_ARPU) {
    this.NEW_ORDER_AMOUNT_ARPU = NEW_ORDER_AMOUNT_ARPU;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_NEW_ORDER_AMOUNT_NOT0_ARPU(java.math.BigDecimal NEW_ORDER_AMOUNT_NOT0_ARPU) {
    this.NEW_ORDER_AMOUNT_NOT0_ARPU = NEW_ORDER_AMOUNT_NOT0_ARPU;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_BILL_USER_COUNT(java.math.BigDecimal BILL_USER_COUNT) {
    this.BILL_USER_COUNT = BILL_USER_COUNT;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_BILL_AMOUNT(java.math.BigDecimal BILL_AMOUNT) {
    this.BILL_AMOUNT = BILL_AMOUNT;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_BILL_AMOUNT_ARPU(java.math.BigDecimal BILL_AMOUNT_ARPU) {
    this.BILL_AMOUNT_ARPU = BILL_AMOUNT_ARPU;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  ...
  public st_diff_bandwidth_income_m with_PT_MON(String PT_MON) {
    this.PT_MON = PT_MON;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof st_diff_bandwidth_income_m)) {
      return false;
    }
    st_diff_bandwidth_income_m that = (st_diff_bandwidth_income_m) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.STD_BANDWIDTH_CODE = JdbcWritableBridge.readString(4, __dbResults);
    this.STD_BANDWIDTH_NAME = JdbcWritableBridge.readString(5, __dbResults);
    this.NEW_ORDER_USER_COUNT = JdbcWritableBridge.readBigDecimal(6, __dbResults);
    this.NEW_ORDER_AMOUNT = JdbcWritableBridge.readBigDecimal(7, __dbResults);
    this.NEW_ORDER_AMOUNT_ARPU = JdbcWritableBridge.readBigDecimal(8, __dbResults);
    this.NEW_ORDER_AMOUNT_NOT0_ARPU = JdbcWritableBridge.readBigDecimal(9, __dbResults);
    this.BILL_USER_COUNT = JdbcWritableBridge.readBigDecimal(10, __dbResults);
    this.BILL_AMOUNT = JdbcWritableBridge.readBigDecimal(11, __dbResults);
    this.BILL_AMOUNT_ARPU = JdbcWritableBridge.readBigDecimal(12, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(STD_BANDWIDTH_CODE, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(STD_BANDWIDTH_NAME, 5 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(NEW_ORDER_USER_COUNT, 6 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(NEW_ORDER_AMOUNT, 7 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(NEW_ORDER_AMOUNT_ARPU, 8 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(NEW_ORDER_AMOUNT_NOT0_ARPU, 9 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(BILL_USER_COUNT, 10 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(BILL_AMOUNT, 11 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(BILL_AMOUNT_ARPU, 12 + __off, 3, __dbStmt);
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    st_diff_bandwidth_income_m o = (st_diff_bandwidth_income_m) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(st_diff_bandwidth_income_m o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
