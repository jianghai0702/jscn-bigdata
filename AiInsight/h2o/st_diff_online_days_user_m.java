// ORM class for table 'st_diff_online_days_user_m'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Dec 18 18:35:31 CST 2018
...
public class st_diff_online_days_user_m extends SqoopRecord  implements DBWritable, Writable {
  ...
  public st_diff_online_days_user_m with_CYCLE_ID(String CYCLE_ID) {
    this.CYCLE_ID = CYCLE_ID;
    return this;
  }
  private String STD_ONLINE_DAYS_CODE;
  public String get_STD_ONLINE_DAYS_CODE() {
    return STD_ONLINE_DAYS_CODE;
  }
  public void set_STD_ONLINE_DAYS_CODE(String STD_ONLINE_DAYS_CODE) {
    this.STD_ONLINE_DAYS_CODE = STD_ONLINE_DAYS_CODE;
  }
  public st_diff_online_days_user_m with_STD_ONLINE_DAYS_CODE(String STD_ONLINE_DAYS_CODE) {
    this.STD_ONLINE_DAYS_CODE = STD_ONLINE_DAYS_CODE;
    return this;
  }
  private String STD_ONLINE_DAYS_NAME;
  public String get_STD_ONLINE_DAYS_NAME() {
    return STD_ONLINE_DAYS_NAME;
  }
  public void set_STD_ONLINE_DAYS_NAME(String STD_ONLINE_DAYS_NAME) {
    this.STD_ONLINE_DAYS_NAME = STD_ONLINE_DAYS_NAME;
  }
  public st_diff_online_days_user_m with_STD_ONLINE_DAYS_NAME(String STD_ONLINE_DAYS_NAME) {
    this.STD_ONLINE_DAYS_NAME = STD_ONLINE_DAYS_NAME;
    return this;
  }
  ...
  public st_diff_online_days_user_m with_USER_COUNT(java.math.BigDecimal USER_COUNT) {
    this.USER_COUNT = USER_COUNT;
    return this;
  }
  ...
  public st_diff_online_days_user_m with_USER_RATE(java.math.BigDecimal USER_RATE) {
    this.USER_RATE = USER_RATE;
    return this;
  }
  ...
  public st_diff_online_days_user_m with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  ...
  public st_diff_online_days_user_m with_OWN_CORP_STD_ORG_CODE(String OWN_CORP_STD_ORG_CODE) {
    this.OWN_CORP_STD_ORG_CODE = OWN_CORP_STD_ORG_CODE;
    return this;
  }
  ...
  public st_diff_online_days_user_m with_OWN_CORP_STD_ORG_NAME(String OWN_CORP_STD_ORG_NAME) {
    this.OWN_CORP_STD_ORG_NAME = OWN_CORP_STD_ORG_NAME;
    return this;
  }
  ...
  public st_diff_online_days_user_m with_PT_MON(String PT_MON) {
    this.PT_MON = PT_MON;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof st_diff_online_days_user_m)) {
      return false;
    }
    st_diff_online_days_user_m that = (st_diff_online_days_user_m) o;
    boolean equal = true;
    equal = equal && (this.CYCLE_ID == null ? that.CYCLE_ID == null : this.CYCLE_ID.equals(that.CYCLE_ID));
    equal = equal && (this.STD_ONLINE_DAYS_CODE == null ? that.STD_ONLINE_DAYS_CODE == null : this.STD_ONLINE_DAYS_CODE.equals(that.STD_ONLINE_DAYS_CODE));
    equal = equal && (this.STD_ONLINE_DAYS_NAME == null ? that.STD_ONLINE_DAYS_NAME == null : this.STD_ONLINE_DAYS_NAME.equals(that.STD_ONLINE_DAYS_NAME));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.STD_ONLINE_DAYS_CODE = JdbcWritableBridge.readString(2, __dbResults);
    this.STD_ONLINE_DAYS_NAME = JdbcWritableBridge.readString(3, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(STD_ONLINE_DAYS_CODE, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(STD_ONLINE_DAYS_NAME, 3 + __off, 12, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.STD_ONLINE_DAYS_CODE = null;
    } else {
    this.STD_ONLINE_DAYS_CODE = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.STD_ONLINE_DAYS_NAME = null;
    } else {
    this.STD_ONLINE_DAYS_NAME = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.STD_ONLINE_DAYS_CODE) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, STD_ONLINE_DAYS_CODE);
    }
    if (null == this.STD_ONLINE_DAYS_NAME) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, STD_ONLINE_DAYS_NAME);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(STD_ONLINE_DAYS_CODE==null?"null":STD_ONLINE_DAYS_CODE, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(STD_ONLINE_DAYS_NAME==null?"null":STD_ONLINE_DAYS_NAME, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.STD_ONLINE_DAYS_CODE = null; } else {
      this.STD_ONLINE_DAYS_CODE = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.STD_ONLINE_DAYS_NAME = null; } else {
      this.STD_ONLINE_DAYS_NAME = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    st_diff_online_days_user_m o = (st_diff_online_days_user_m) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(st_diff_online_days_user_m o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("STD_ONLINE_DAYS_CODE", this.STD_ONLINE_DAYS_CODE);
    __sqoop$field_map.put("STD_ONLINE_DAYS_NAME", this.STD_ONLINE_DAYS_NAME);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("STD_ONLINE_DAYS_CODE".equals(__fieldName)) {
      this.STD_ONLINE_DAYS_CODE = (String) __fieldVal;
    }
    else    if ("STD_ONLINE_DAYS_NAME".equals(__fieldName)) {
      this.STD_ONLINE_DAYS_NAME = (String) __fieldVal;
    }
