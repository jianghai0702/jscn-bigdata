// ORM class for table 'st_diff_offer_urltype_user_m'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Dec 18 18:52:10 CST 2018
...
public class st_diff_offer_urltype_user_m extends SqoopRecord  implements DBWritable, Writable {
  ...
  public st_diff_offer_urltype_user_m with_OWN_CORP_STD_ORG_CODE(String OWN_CORP_STD_ORG_CODE) {
    this.OWN_CORP_STD_ORG_CODE = OWN_CORP_STD_ORG_CODE;
    return this;
  }
  ...
  public st_diff_offer_urltype_user_m with_OWN_CORP_STD_ORG_NAME(String OWN_CORP_STD_ORG_NAME) {
    this.OWN_CORP_STD_ORG_NAME = OWN_CORP_STD_ORG_NAME;
    return this;
  }
  ...
  public st_diff_offer_urltype_user_m with_STD_OFFER_CODE(String STD_OFFER_CODE) {
    this.STD_OFFER_CODE = STD_OFFER_CODE;
    return this;
  }
  ...
  public st_diff_offer_urltype_user_m with_STD_OFFER_NAME(String STD_OFFER_NAME) {
    this.STD_OFFER_NAME = STD_OFFER_NAME;
    return this;
  }
  ...
  public void set_URL_TYPE(String URL_TYPE) {
    this.URL_TYPE = URL_TYPE;
  }
  public st_diff_offer_urltype_user_m with_URL_TYPE(String URL_TYPE) {
    this.URL_TYPE = URL_TYPE;
    return this;
  }
  ...
  public st_diff_offer_urltype_user_m with_VISIT_COUNT(java.math.BigDecimal VISIT_COUNT) {
    this.VISIT_COUNT = VISIT_COUNT;
    return this;
  }
  ...
  public st_diff_offer_urltype_user_m with_VISIT_USER_COUNT(java.math.BigDecimal VISIT_USER_COUNT) {
    this.VISIT_USER_COUNT = VISIT_USER_COUNT;
    return this;
  }
  ...
  public st_diff_offer_urltype_user_m with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  ...
  public st_diff_offer_urltype_user_m with_PT_MON(String PT_MON) {
    this.PT_MON = PT_MON;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof st_diff_offer_urltype_user_m)) {
      return false;
    }
    st_diff_offer_urltype_user_m that = (st_diff_offer_urltype_user_m) o;
    boolean equal = true;
    ...
    equal = equal && (this.URL_TYPE == null ? that.URL_TYPE == null : this.URL_TYPE.equals(that.URL_TYPE));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.STD_OFFER_CODE = JdbcWritableBridge.readString(3, __dbResults);
    this.STD_OFFER_NAME = JdbcWritableBridge.readString(4, __dbResults);
    this.URL_TYPE = JdbcWritableBridge.readString(5, __dbResults);
    this.VISIT_COUNT = JdbcWritableBridge.readBigDecimal(6, __dbResults);
    this.VISIT_USER_COUNT = JdbcWritableBridge.readBigDecimal(7, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(STD_OFFER_CODE, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(STD_OFFER_NAME, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(URL_TYPE, 5 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(VISIT_COUNT, 6 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(VISIT_USER_COUNT, 7 + __off, 3, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.URL_TYPE = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.URL_TYPE) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, URL_TYPE);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(URL_TYPE==null?"null":URL_TYPE, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.URL_TYPE = null; } else {
      this.URL_TYPE = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    st_diff_offer_urltype_user_m o = (st_diff_offer_urltype_user_m) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(st_diff_offer_urltype_user_m o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("URL_TYPE", this.URL_TYPE);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("URL_TYPE".equals(__fieldName)) {
      this.URL_TYPE = (String) __fieldVal;
    }
