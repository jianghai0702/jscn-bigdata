// ORM class for table 'ST_DNAME_TOPN'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 27 11:56:10 CST 2018
...
public class ST_DNAME_TOPN extends SqoopRecord  implements DBWritable, Writable {
  ...
  public ST_DNAME_TOPN with_CYCLE_ID(String CYCLE_ID) {
    this.CYCLE_ID = CYCLE_ID;
    return this;
  }
  ...
  public void set_nodeid(String nodeid) {
    this.nodeid = nodeid;
  }
  public ST_DNAME_TOPN with_nodeid(String nodeid) {
    this.nodeid = nodeid;
    return this;
  }
  ...
  public ST_DNAME_TOPN with_DNAME(String DNAME) {
    this.DNAME = DNAME;
    return this;
  }
  ...
  public ST_DNAME_TOPN with_in_gbs(java.math.BigDecimal in_gbs) {
    this.in_gbs = in_gbs;
    return this;
  }
  ...
  public ST_DNAME_TOPN with_out_gbs(java.math.BigDecimal out_gbs) {
    this.out_gbs = out_gbs;
    return this;
  }
  ...
  public ST_DNAME_TOPN with_total_gbs(java.math.BigDecimal total_gbs) {
    this.total_gbs = total_gbs;
    return this;
  }
  ...
  public ST_DNAME_TOPN with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  ...
  public ST_DNAME_TOPN with_pt_time(String pt_time) {
    this.pt_time = pt_time;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ST_DNAME_TOPN)) {
      return false;
    }
    ST_DNAME_TOPN that = (ST_DNAME_TOPN) o;
    boolean equal = true;
    equal = equal && (this.CYCLE_ID == null ? that.CYCLE_ID == null : this.CYCLE_ID.equals(that.CYCLE_ID));
    equal = equal && (this.nodeid == null ? that.nodeid == null : this.nodeid.equals(that.nodeid));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.nodeid = JdbcWritableBridge.readString(2, __dbResults);
    this.DNAME = JdbcWritableBridge.readString(3, __dbResults);
    this.in_gbs = JdbcWritableBridge.readBigDecimal(4, __dbResults);
    this.out_gbs = JdbcWritableBridge.readBigDecimal(5, __dbResults);
    this.total_gbs = JdbcWritableBridge.readBigDecimal(6, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(nodeid, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(DNAME, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(in_gbs, 4 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(out_gbs, 5 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(total_gbs, 6 + __off, 3, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.nodeid = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.DNAME = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.nodeid) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, nodeid);
    }
    if (null == this.DNAME) { 
        __dataOut.writeBoolean(true);
    } else {
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(nodeid==null?"null":nodeid, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.nodeid = null; } else {
      this.nodeid = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.DNAME = null; } else {
  ...
  public Object clone() throws CloneNotSupportedException {
    ST_DNAME_TOPN o = (ST_DNAME_TOPN) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(ST_DNAME_TOPN o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("nodeid", this.nodeid);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("nodeid".equals(__fieldName)) {
      this.nodeid = (String) __fieldVal;
    }
    else    if ("DNAME".equals(__fieldName)) {
      this.DNAME = (String) __fieldVal;
    }
