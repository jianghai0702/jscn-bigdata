// ORM class for table 'st_web_browse_m'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Dec 18 19:42:18 CST 2018
...
public class st_web_browse_m extends SqoopRecord  implements DBWritable, Writable {
  ...
  public st_web_browse_m with_CYCLE_ID(String CYCLE_ID) {
    this.CYCLE_ID = CYCLE_ID;
    return this;
  }
  ...
  public st_web_browse_m with_REGION_NAME(String REGION_NAME) {
    this.REGION_NAME = REGION_NAME;
    return this;
  }
  ...
  public st_web_browse_m with_PERFORMANCE(java.math.BigDecimal PERFORMANCE) {
    this.PERFORMANCE = PERFORMANCE;
    return this;
  }
  ...
  public st_web_browse_m with_FIRST_SCREEN_TIME(java.math.BigDecimal FIRST_SCREEN_TIME) {
    this.FIRST_SCREEN_TIME = FIRST_SCREEN_TIME;
    return this;
  }
  ...
  public st_web_browse_m with_DOWNLOAD_SPEED(java.math.BigDecimal DOWNLOAD_SPEED) {
    this.DOWNLOAD_SPEED = DOWNLOAD_SPEED;
    return this;
  }
  ...
  public st_web_browse_m with_MONITOR_COUNT(java.math.BigDecimal MONITOR_COUNT) {
    this.MONITOR_COUNT = MONITOR_COUNT;
    return this;
  }
  ...
  public st_web_browse_m with_ETL_DATE(java.sql.Timestamp ETL_DATE) {
    this.ETL_DATE = ETL_DATE;
    return this;
  }
  private java.math.BigDecimal BASIC_DOC_DOWNLOAD_BYTES;
  public java.math.BigDecimal get_BASIC_DOC_DOWNLOAD_BYTES() {
    return BASIC_DOC_DOWNLOAD_BYTES;
  }
  public void set_BASIC_DOC_DOWNLOAD_BYTES(java.math.BigDecimal BASIC_DOC_DOWNLOAD_BYTES) {
    this.BASIC_DOC_DOWNLOAD_BYTES = BASIC_DOC_DOWNLOAD_BYTES;
  }
  public st_web_browse_m with_BASIC_DOC_DOWNLOAD_BYTES(java.math.BigDecimal BASIC_DOC_DOWNLOAD_BYTES) {
    this.BASIC_DOC_DOWNLOAD_BYTES = BASIC_DOC_DOWNLOAD_BYTES;
    return this;
  }
  ...
  public st_web_browse_m with_PT_MON(String PT_MON) {
    this.PT_MON = PT_MON;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof st_web_browse_m)) {
      return false;
    }
    st_web_browse_m that = (st_web_browse_m) o;
    boolean equal = true;
    ...
    equal = equal && (this.BASIC_DOC_DOWNLOAD_BYTES == null ? that.BASIC_DOC_DOWNLOAD_BYTES == null : this.BASIC_DOC_DOWNLOAD_BYTES.equals(that.BASIC_DOC_DOWNLOAD_BYTES));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.DOWNLOAD_SPEED = JdbcWritableBridge.readBigDecimal(5, __dbResults);
    ...
    this.BASIC_DOC_DOWNLOAD_BYTES = JdbcWritableBridge.readBigDecimal(8, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeBigDecimal(DOWNLOAD_SPEED, 5 + __off, 3, __dbStmt);
    ...
    JdbcWritableBridge.writeBigDecimal(BASIC_DOC_DOWNLOAD_BYTES, 8 + __off, 3, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.BASIC_DOC_DOWNLOAD_BYTES = null;
    } else {
    this.BASIC_DOC_DOWNLOAD_BYTES = com.cloudera.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.PT_MON = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.BASIC_DOC_DOWNLOAD_BYTES) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    com.cloudera.sqoop.lib.BigDecimalSerializer.write(this.BASIC_DOC_DOWNLOAD_BYTES, __dataOut);
    }
    if (null == this.PT_MON) { 
        __dataOut.writeBoolean(true);
    } else {
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(BASIC_DOC_DOWNLOAD_BYTES==null?"null":BASIC_DOC_DOWNLOAD_BYTES.toPlainString(), delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.BASIC_DOC_DOWNLOAD_BYTES = null; } else {
      this.BASIC_DOC_DOWNLOAD_BYTES = new java.math.BigDecimal(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    st_web_browse_m o = (st_web_browse_m) super.clone();
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
    return o;
  }

  public void clone0(st_web_browse_m o) throws CloneNotSupportedException {
    o.ETL_DATE = (o.ETL_DATE != null) ? (java.sql.Timestamp) o.ETL_DATE.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("BASIC_DOC_DOWNLOAD_BYTES", this.BASIC_DOC_DOWNLOAD_BYTES);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    ...
    else    if ("BASIC_DOC_DOWNLOAD_BYTES".equals(__fieldName)) {
      this.BASIC_DOC_DOWNLOAD_BYTES = (java.math.BigDecimal) __fieldVal;
    }
