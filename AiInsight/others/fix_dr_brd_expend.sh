...
ssh jsgd4 > /dev/null 2>&1 <<EOF
    ...
    nohup python /AiInsight/dw/DWA_DIFF_TIMES_USER_D.py ${v_cycle} &
    nohup python /AiInsight/dw/DWA_USER_ONLINE_LENGTH_D.py ${v_cycle} &
    nohup python /AiInsight/dw/DWA_DIFF_ONLINE_MEDIA_USER_D.py ${v_cycle} &
    ...
    nohup python /AiInsight/dw/DWA_DNS_DOWN_STREAM_D.py ${v_cycle} &
    nohup python /AiInsight/dw/DWA_DNS_UP_STREAM_D.py ${v_cycle} &
