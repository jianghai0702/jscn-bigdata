...
##自定义变量声明---源表声明                                                          
##===========================================================================     
    s_stg_zg_acct_item_slice           =    "stg_zg_acct_item_slice"
##===========================================================================       
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_dwd_zg_acct_item_slice           =    "dwd_zg_acct_item_slice"
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
...
##===========================================================================
#生成当月数据
    hsql='''insert overwrite table %(t_dwd_zg_acct_item_slice)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
            select
              t1.acct_item_slice_id,
              t1.acct_item_id,
              t1.bill_id,
              t1.bill_amount,
              t1.acct_id,
            ...
            from %(s_stg_zg_acct_item_slice)s t1
            where t1.pt_time=%(ARG_OPTIME_LAST1_M)s
            '''% vars()
