...
##自定义变量声明---源表声明                                                          
##===========================================================================     
    s_stg_ins_prod_ext               =    "stg_ins_prod_ext"
##===========================================================================       
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_dwd_ins_prod_ext              =    "dwd_ins_prod_ext"
...
#生成 当天数据
    hsql='''
    insert overwrite table %(t_dwd_ins_prod_ext)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
            select a.OWN_CORP_ORG_ID 
                  ,a.PROD_INST_ID
                  ,b.STD_ORG_CODE as OWN_CORP_STD_ORG_CODE
            from %(s_stg_ins_prod_ext)s a
            left join %(s_dwd_dim_std_organize)s b
              on a.OWN_CORP_ORG_ID = b.ORGANIZE_ID
