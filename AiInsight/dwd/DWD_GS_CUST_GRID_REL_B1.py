...
# -*-coding:utf-8 -*-
#-------------------------------------------------------------------------------
# Name: DWD客户网格关系表BOSS1
# Pay: DWD_GS_CUST_GRID_REL_B1.py
# Purpose: 
# 
# Author:      wangxx
# 
...
# 目标表声明
#-------------------------------------------------------------------------------
t_dwd_gs_cust_grid_rel_b1                =    "dwd_gs_cust_grid_rel_b1"
...
try:
    ...
    # hsql='''
    #     INSERT overwrite table %(t_dwd_gs_cust_grid_rel_b1)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
    #     SELECT distinct
    #       CUST_ID             ,
    #       GRID_ID             ,
    #       GRID_NAME           ,
    ...
    #       from %(s_stg_gs_cust_grid_rel_b1)s
