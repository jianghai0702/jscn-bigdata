...
##自定义变量声明---目标表声明
##===========================================================================
    t_dwd_fact_ins_srvpkg           =    "dwd_fact_ins_srvpkg"
##===========================================================================
##创建临时表
##===========================================================================
...
##===========================================================================
#生成 当天数据
    # hsql='''insert overwrite table %(t_dwd_fact_ins_srvpkg)s partition(pt_mon=%(ARG_OPTIME_LAST1_M)s)
    #         select distinct
    #           t1.srvpkg_inst_id      ,
    #           t1.offer_inst_id       ,
    #           t1.offer_id            ,
