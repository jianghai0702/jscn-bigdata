...
##自定义变量声明---源表声明                                                          
##===========================================================================     
    s_stg_h_ins_prod                =    "stg_h_ins_prod"
    s_dwd_sec_organize              =    "dwd_sec_organize"
##===========================================================================       
##自定义变量声明---目标表声明                                                        
##=========================================================================== 
    t_dwd_h_ins_prod                =    "dwd_h_ins_prod"    
##===========================================================================       
##创建临时表                                                                       
##===========================================================================
...
##===========================================================================
#删除变更数据
    hsql='''insert overwrite table %(t_dwd_h_ins_prod)s partition(pt_year=%(ARG_OPTIME_LAST_Y)s)
            select
              t1.h_id,
              t1.prod_inst_id,
              t1.offer_inst_id,
              ...
              t1.etl_cycle,
              t1.etl_date
            from %(t_dwd_h_ins_prod)s t1
            left outer join %(s_stg_h_ins_prod)s t2 on t1.prod_inst_id = t2.prod_inst_id and t2.pt_time=%(ARG_OPTIME_LASTDAY)s
...
#生成目标表数据
    hsql='''insert into table %(t_dwd_h_ins_prod)s  partition(pt_year=%(ARG_OPTIME_LAST_Y)s)
            select
              t1.h_id,
              t1.prod_inst_id,
              t1.offer_inst_id,
